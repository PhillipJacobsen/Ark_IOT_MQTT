/********************************************************************************
    Demo project that integrates Ark Blockchain interface with MQTT protocol

    Ark_IOT_MQTT.ino
    2019 @phillipjacobsen

    Program Features:
    This program has been tested with ESP32 Adafruit Huzzah.
    This sketch uses the ARK Cpp-Client API to interact with an Ark V2.4 Devnet node or Custom v2.4 Ark Bridgechain
...
#define HOME    //undefine for work wifi
...
//Nybble BridgeChain Testnet/Devnet-> make sure to set epoch in devnet.h to     "2019-06-18T22:44:26.320Z"  // Epoch
//Ark Devnet make sure to set epoch in devnet.h to     "2017-03-21T13:00:00.000Z"  // Epoch
